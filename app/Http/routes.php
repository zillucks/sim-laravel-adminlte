...
Route::group(['middleware' => 'auth'], function() {
	...
	Route::group(['middleware' => 'role:administrator,manager'], function () {
		...
		Route::get('karyawan/tambahkaryawan', 'AdminController@tambahkaryawan')->name('karyawan.tambahkaryawan');
		Route::get('karyawan/tambahkaryawan/{kdkaryawan}', 'AdminController@tambahkaryawan')->name('karyawan.editkaryawan');
		Route::post('karyawan/tambahkaryawan/{kdkaryawan?}', 'AdminController@tambahkaryawan')->name('karyawan.tambahkaryawan');
	...
	/**
	 * @role administrator, apoteker
	 */

	Route::group(['middleware' => 'role:administrator,apoteker'], function () {
	...
	/**
	 * @role administrator,apoteker,kasir
	 */
	Route::group(['middleware' => 'role:administrator,apoteker,kasir'], function () {
...
/**
 * @route for CORS (Cross Origin Resource Sharing)
 */
